...
var name=document.getElementById("name");
 function validate() {
  ...
  if( document.form.year.value == "" || document.form.year.value.length !=4 || document.form.year.value >2100 || document.myForm.year.value <=1900) {
     confirm( "Please provide a valid year of birth! eg 2019" );
  ...
  document.form.month.value.length != 2 || document.form.month.value > 12  || document.form.month.value <= 0){
     confirm( "Please provide your month of birth! between 1 and 12" );
  ...
  document.form.month.value.length != 2|| document.form.date.value > 31 || document.form.date.value <= 0) {
     confirm( "Please provide a valid date that you were born in!" );
     document.myForm.day.focus() ;
     return false;
  }
  else if(genders[0].checked==false && genders[1].checked==false ) {
      confirm("You must select male or female");
      return false;
  }   
  else{
    return true ;
